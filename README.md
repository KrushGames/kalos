...
[![Google Cloud Shell](https://gstatic.com/cloudssh/images/open-btn.png)](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/KrushGames/pokeclicker&git_branch=Kalos&page=editor&open_in_editor=README.md)
```cmd
npm clean-install
npm start
```
